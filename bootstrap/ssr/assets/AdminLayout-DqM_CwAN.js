...
import { LayoutDashboard, Newspaper, Image, Users, Calendar, BarChart, Quote, Settings, FileText, User, Globe, LogOut, Menu, Sun, Moon, Bell, ChevronDown } from "lucide-react";
function Sidebar({ isOpen, setIsOpen }) {
  ...
  const NavLink = ({ item }) => /* @__PURE__ */ jsxs(
    Link,
    {
      ...
      className: `flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group ${isActive(item.href) ? "bg-emerald-600 text-white shadow-lg shadow-emerald-600/30" : "text-slate-500 hover:bg-emerald-50 hover:text-emerald-600 dark:text-slate-400 dark:hover:bg-slate-800"}`,
      children: [
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("aside", { className: `fixed top-0 left-0 z-40 h-screen bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-all duration-300 ${isOpen ? "w-64" : "w-64 -translate-x-full lg:translate-x-0 lg:w-20"}`, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "h-20 flex items-center justify-center border-b border-slate-100 dark:border-slate-800", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: `ml-3 font-bold text-slate-800 dark:text-white text-lg transition-all duration-300 ${isOpen ? "opacity-100 w-auto" : "opacity-0 w-0 overflow-hidden"}`, children: "AdminPanel" })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        ...
        isProfileOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute right-0 mt-2 w-48 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-100 dark:border-slate-800 overflow-hidden z-50", children: [
...
function AdminLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300", children: [
    /* @__PURE__ */ jsx(Head, { children: siteSetting?.favicon && /* @__PURE__ */ jsxs(Fragment, { children: [
