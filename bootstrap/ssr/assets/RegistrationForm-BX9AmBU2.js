...
function RegistrationForm({ agenda, pageSetting }) {
  ...
  const schema = agenda.form_schema && Array.isArray(agenda.form_schema) && agenda.form_schema.length > 0 ? agenda.form_schema : defaultSchema;
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
            agenda.registration_fee && /* @__PURE__ */ jsxs("div", { className: "mb-8 space-y-6 border-b border-slate-100 pb-8", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-6 bg-emerald-50 border border-emerald-100 rounded-xl flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-emerald-700", children: isFree ? "Kegiatan ini tidak dipungut biaya." : "Silakan pilih metode pembayaran di bawah ini." })
                ] }),
              ...
              !isFree && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-3 p-4 rounded-xl cursor-pointer border-2 transition-all ${data.payment_method === "midtrans" ? "border-emerald-500 bg-emerald-50" : "border-slate-200 bg-white hover:border-emerald-200"}`, children: [
                      /* @__PURE__ */ jsx("input", { type: "radio", name: "payment_method", value: "midtrans", className: "w-4 h-4 text-emerald-600 focus:ring-emerald-500", checked: data.payment_method === "midtrans", onChange: () => setData("payment_method", "midtrans") }),
                      /* @__PURE__ */ jsx("span", { className: "font-bold text-slate-700", children: "Otomatis (Midtrans)" })
                    ] }),
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-3 p-4 rounded-xl cursor-pointer border-2 transition-all ${data.payment_method === "cash" ? "border-emerald-500 bg-emerald-50" : "border-slate-200 bg-white hover:border-emerald-200"}`, children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "font-bold text-slate-700", children: "Cash / Langsung" })
                    ] }),
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-3 p-4 rounded-xl cursor-pointer border-2 transition-all ${data.payment_method === "transfer" ? "border-emerald-500 bg-emerald-50" : "border-slate-200 bg-white hover:border-emerald-200"}`, children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "font-bold text-slate-700", children: "Manual Transfer" })
                    ] })
                  ] }),
