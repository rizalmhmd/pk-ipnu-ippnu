...
function Edit({ mustVerifyEmail, status, member }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-12 xl:col-span-8", children: /* @__PURE__ */ jsxs("form", { onSubmit: updateProfile, className: "bg-white dark:bg-slate-900 p-10 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 flex flex-col items-center justify-center p-8 bg-slate-50 dark:bg-slate-800/50 rounded-[2rem] border-2 border-dashed border-slate-200 dark:border-slate-700 mb-4 text-center", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsx("div", { className: "w-32 h-32 rounded-[2rem] overflow-hidden bg-slate-200 dark:bg-slate-700 shadow-xl border-4 border-white dark:border-slate-900 ring-4 ring-emerald-500/10", children: photoPreview ? /* @__PURE__ */ jsx("img", { src: photoPreview, alt: "Preview", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("div", { className: "w-full h-full flex items-center justify-center text-slate-400", children: /* @__PURE__ */ jsx(User, { size: 48 }) }) }),
              /* @__PURE__ */ jsxs("label", { className: "absolute -bottom-2 -right-2 p-3 bg-emerald-600 text-white rounded-2xl shadow-lg cursor-pointer hover:bg-emerald-700 transition-all hover:scale-110", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "flex gap-4", children: ["ipnu", "ippnu"].map((type) => /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `flex-1 py-4 rounded-2xl border-2 font-bold uppercase tracking-widest text-xs transition-all ${profileForm.data.type === type ? "bg-emerald-600 border-emerald-600 text-white shadow-lg shadow-emerald-600/20" : "bg-transparent border-slate-100 dark:border-slate-800 text-slate-400 hover:border-emerald-500/50"}`,
                  children: type
                },
                type
              )) })
