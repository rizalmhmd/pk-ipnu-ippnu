...
function VerifyEmail({ status }) {
  ...
  return /* @__PURE__ */ jsxs(GuestLayout, { children: [
    ...
    status === "verification-link-sent" && /* @__PURE__ */ jsx("div", { className: "mb-6 font-bold text-sm text-emerald-600 bg-emerald-50 p-4 rounded-2xl border border-emerald-100 italic", children: "Tautan verifikasi baru telah dikirim ke alamat email yang Anda berikan saat pendaftaran." }),
