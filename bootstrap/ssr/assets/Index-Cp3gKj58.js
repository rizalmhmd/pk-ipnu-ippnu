    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "relative h-32 sm:h-56 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-3 left-3 sm:bottom-4 sm:left-4", children: /* @__PURE__ */ jsx("span", { className: "px-3 py-1 sm:px-4 sm:py-1.5 bg-white/90 backdrop-blur-md text-emerald-600 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider rounded-lg sm:rounded-lg shadow-lg border border-white/20", children: "Berita" }) })
        ] }),
...
function NewsIndex({ posts, pageSetting }) {
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6 md:px-12 py-12 md:py-20", children: [
      /* @__PURE__ */ jsx(SectionTitle, { centered: true, className: "mb-10 lg:mb-16", children: "Warta Organisasi" }),
      ...
      posts.data.length === 0 && /* @__PURE__ */ jsxs("div", { className: "py-20 text-center bg-white rounded-lg shadow-xl shadow-slate-200/50 border border-slate-100", children: [
