        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-10 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "md:row-span-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: `relative group aspect-video border-2 border-dashed rounded-lg overflow-hidden flex items-center justify-center transition-all ${previews.default_hero_image ? "border-emerald-500" : "border-slate-100 dark:border-slate-800"}`, children: [
                ...
                previews.default_hero_image ? /* @__PURE__ */ jsxs("div", { className: "w-full h-full relative", children: [
                  /* @__PURE__ */ jsx("img", { src: previews.default_hero_image, className: "w-full h-full object-cover" }),
                  /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-slate-900/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center transition-all duration-300", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
                      /* @__PURE__ */ jsx(Image, { size: 32, className: "text-white mb-2" }),
                      /* @__PURE__ */ jsx("p", { className: "text-white font-bold text-[10px] uppercase tracking-widest leading-none", children: "Ganti" })
                    ] }),
                    /* @__PURE__ */ jsxs(
                      "button",
                      {
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-8 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: `relative group p-6 border-2 border-dashed rounded-lg flex items-center justify-center transition-all ${previews.site_logo ? "border-emerald-500 bg-emerald-50/20" : "border-slate-50 dark:border-slate-800"}`, children: [
                ...
                previews.site_logo ? /* @__PURE__ */ jsxs("div", { className: "relative group/logo", children: [
                  /* @__PURE__ */ jsx("img", { src: previews.site_logo, className: "max-h-20 object-contain" }),
                  /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm opacity-0 group-hover/logo:opacity-100 flex items-center justify-center gap-4 transition-all duration-300 rounded-lg", children: [
                    /* @__PURE__ */ jsx(Image, { size: 20, className: "text-slate-400" }),
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        type: "button",
                ...
                ] }) : /* @__PURE__ */ jsx(ImageIcon, { size: 24, className: "text-slate-200" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: `relative group p-6 border-2 border-dashed rounded-lg flex items-center justify-center transition-all ${previews.favicon ? "border-emerald-500 bg-emerald-50/20" : "border-slate-50 dark:border-slate-800"}`, children: [
                ...
                previews.favicon ? /* @__PURE__ */ jsxs("div", { className: "relative group/favicon", children: [
                  /* @__PURE__ */ jsx("img", { src: previews.favicon, className: "w-10 h-10 object-contain shadow-lg" }),
                  /* @__PURE__ */ jsx("div", { className: "absolute -top-2 -right-2 opacity-0 group-hover/favicon:opacity-100 transition-all", children: /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "button",
                ...
                ] }) : /* @__PURE__ */ jsx(ImageIcon, { size: 20, className: "text-slate-200" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-8 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsx("input", { type: "email", value: data.email, onChange: (e) => setData("email", e.target.value), className: "w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-emerald-500 rounded-lg focus:outline-none transition-all font-bold text-sm", placeholder: "Email Organisasi" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(Phone, { size: 16, className: "absolute left-6 top-1/2 -translate-y-1/2 text-slate-400" }),
              /* @__PURE__ */ jsx("input", { type: "text", value: data.phone, onChange: (e) => setData("phone", e.target.value), className: "w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-emerald-500 rounded-lg focus:outline-none transition-all font-bold text-sm", placeholder: "Nomor Telepon/WA" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(Instagram, { size: 16, className: "absolute left-6 top-1/2 -translate-y-1/2 text-slate-400" }),
              /* @__PURE__ */ jsx("input", { type: "text", value: data.instagram, onChange: (e) => setData("instagram", e.target.value), className: "w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-emerald-500 rounded-lg focus:outline-none transition-all font-bold text-sm", placeholder: "Instagram Username" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(MessageCircle, { size: 16, className: "absolute left-6 top-1/2 -translate-y-1/2 text-slate-400" }),
              /* @__PURE__ */ jsx("input", { type: "text", value: data.youtube, onChange: (e) => setData("youtube", e.target.value), className: "w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-emerald-500 rounded-lg focus:outline-none transition-all font-bold text-sm", placeholder: "URL Channel WhatsApp" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(
