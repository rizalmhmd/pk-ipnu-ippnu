        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-slate-50 p-8 border-t border-slate-100", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-8 text-xs font-bold uppercase tracking-widest", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-slate-500", children: "Cuti Bersama" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "w-[95%] max-w-md bg-white rounded-lg shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] p-8 md:p-10 border border-white relative pointer-events-auto", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-4 items-center", children: [
                /* @__PURE__ */ jsx("div", { className: `w-14 h-14 rounded-lg flex items-center justify-center text-xl ${selectedEvent.type === "holiday" ? selectedEvent.cat === "nasional" ? "bg-red-50 text-red-500" : selectedEvent.cat === "keagamaan" ? "bg-blue-50 text-blue-500" : selectedEvent.cat === "cuti_bersama" ? "bg-amber-50 text-amber-500" : "bg-slate-100 text-slate-600" : "bg-emerald-50 text-emerald-500"}`, children: /* @__PURE__ */ jsx("i", { className: `fas ${selectedEvent.type === "holiday" ? selectedEvent.cat === "nasional" ? "fa-flag" : selectedEvent.cat === "keagamaan" ? "fa-mosque" : selectedEvent.cat === "cuti_bersama" ? "fa-calendar-day" : "fa-star" : "fa-calendar-check"}` }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: `px-4 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${selectedEvent.type === "holiday" ? selectedEvent.cat === "nasional" ? "bg-red-500 text-white" : selectedEvent.cat === "keagamaan" ? "bg-blue-500 text-white" : selectedEvent.cat === "cuti_bersama" ? "bg-amber-500 text-white" : "bg-slate-500 text-white" : "bg-emerald-500 text-white"}`, children: selectedEvent.type === "holiday" ? selectedEvent.cat === "nasional" ? "Libur Nasional" : selectedEvent.cat === "keagamaan" ? "Hari Besar Keagamaan" : selectedEvent.cat === "cuti_bersama" ? "Cuti Bersama" : "Hari Istimewa" : selectedEvent.category ? `Agenda ${selectedEvent.category}` : "Agenda Organisasi" }),
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 md:flex-col md:w-24 md:h-24 md:bg-slate-50 md:rounded-lg md:justify-center md:border md:border-slate-100 group-hover:bg-emerald-50 group-hover:border-emerald-100 transition-colors shrink-0", children: [
                        /* @__PURE__ */ jsxs("div", { className: `${isHoliday ? item.cat === "nasional" ? "bg-red-600" : item.cat === "keagamaan" ? "bg-blue-600" : item.cat === "cuti_bersama" ? "bg-amber-600" : "bg-slate-600" : "bg-emerald-600"} text-white w-14 h-14 rounded-lg flex flex-col items-center justify-center md:bg-transparent ${isHoliday ? item.cat === "nasional" ? "md:text-red-600" : item.cat === "keagamaan" ? "md:text-blue-600" : item.cat === "cuti_bersama" ? "md:text-amber-600" : "md:text-slate-600" : "md:text-emerald-600"}`, children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex-grow", children: [
                        ...
                        /* @__PURE__ */ jsx("h4", { className: `text-xl font-bold text-slate-800 font-serif mb-4 transition-colors ${isHoliday ? item.cat === "nasional" ? "group-hover:text-red-700" : item.cat === "keagamaan" ? "group-hover:text-blue-700" : item.cat === "cuti_bersama" ? "group-hover:text-amber-700" : "group-hover:text-slate-700" : "group-hover:text-emerald-700"}`, children: item.title }),
