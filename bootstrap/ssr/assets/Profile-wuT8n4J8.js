...
function MemberCard({ member, idx, onClick }) {
  ...
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[2rem] p-5 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center hover:shadow-2xl hover:shadow-emerald-900/10 hover:-translate-y-2 transition-all duration-500", children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("h5", { className: "text-lg font-bold text-slate-800 font-serif mb-1 leading-tight group-hover:text-emerald-700 transition-all", children: member.name }),
        /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold tracking-widest text-slate-400 mb-4 bg-slate-50 px-3 py-1 rounded-full group-hover:bg-emerald-50 group-hover:text-emerald-600 transition-all", children: member.position }),
...
function Profile({ siteSetting, sections, organizations, pageSetting }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-6 md:px-12 py-20", children: /* @__PURE__ */ jsxs("div", { className: "space-y-32", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: organizations?.length > 0 ? organizations.map((member, i) => /* @__PURE__ */ jsx(MemberCard, { member, idx: i }, i)) : /* @__PURE__ */ jsx("p", { className: "col-span-full text-center text-slate-400 italic", children: "Data pengurus belum tersedia." }) })
      ] })
    ] }) })
  ] });
}
