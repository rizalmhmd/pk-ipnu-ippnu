...
function Gallery({ galleries, pageSetting }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6 md:px-12 py-20", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8", children: galleries.data.map((item, idx) => /* @__PURE__ */ jsxs(
        motion.div,
        {
      ...
      galleries.data.length === 0 && /* @__PURE__ */ jsxs("div", { className: "py-20 text-center bg-white rounded-[3rem] shadow-xl shadow-slate-200/50 border border-slate-100", children: [
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-8 px-8 py-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl text-white text-center pointer-events-auto", children: /* @__PURE__ */ jsx("h4", { className: "text-lg font-bold font-serif", children: selectedImage.title }) })
          ]
        }
      )
    ] }) })
