...
import { ArrowLeft, History, CloudUpload, X, Save, Lightbulb, Image, FileText } from "lucide-react";
function Edit({ article }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: `Edit Artikel - ${article.title}` }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-extrabold text-slate-900 dark:text-white leading-tight", children: "Edit Artikel" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 font-medium", children: "Perbarui konten dan informasi artikel yang sudah dipublikasikan." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 px-6 py-3 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-slate-700 dark:text-slate-300", children: [
            new Date(article.updated_at).toLocaleDateString("id-ID", { day: "numeric", month: "long", year: "numeric", hour: "2-digit", minute: "2-digit" }),
            " WIB"
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "grid grid-cols-1 lg:grid-cols-12 gap-10", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-8 space-y-8", children: /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-slate-900 p-10 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-900 dark:text-white mb-3", children: "Judul Artikel" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-900 dark:text-white", children: "Penulis" }),
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md", children: "Opsional" })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
          ...
          errors.author && /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs font-bold text-red-500 uppercase tracking-wider", children: errors.author })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-900 dark:text-white", children: "Gambar Utama" }),
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md", children: "Opsional" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: `relative group border-2 border-dashed rounded-lg p-10 text-center transition-all ${imagePreview ? "border-emerald-500 bg-emerald-50/30 dark:bg-emerald-900/10" : "border-slate-100 dark:border-slate-800 hover:border-emerald-400 dark:hover:border-emerald-600"}`, children: [
            ...
            imagePreview ? /* @__PURE__ */ jsxs("div", { className: "relative inline-block", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center rounded-lg transition-all duration-300", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "font-bold text-xs text-white", children: "Hapus Gambar" })
                    ]
                  }
                )
              ] }) })
              ...
              /* @__PURE__ */ jsx("h5", { className: "font-bold text-slate-900 dark:text-white mb-2 text-lg", children: "Ganti Foto Artikel" }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-900 dark:text-white mb-3", children: "Isi Artikel Lengkap" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              value: data.content,
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-4 space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-emerald-600 p-10 rounded-lg text-white shadow-2xl shadow-emerald-900/20 relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
            ...
            /* @__PURE__ */ jsxs("ul", { className: "space-y-6", children: [
              ...
              /* @__PURE__ */ jsxs("li", { className: "flex gap-4", children: [
                /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 bg-emerald-300 rounded-full shrink-0 mt-1.5" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm font-medium leading-relaxed text-emerald-50", children: "Update isi artikel jika terdapat perkembangan informasi terbaru." })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-8 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "aspect-[4/3] bg-slate-50 dark:bg-slate-800 rounded-lg overflow-hidden border border-slate-100 dark:border-slate-700", children: imagePreview ? /* @__PURE__ */ jsx("img", { src: imagePreview, className: "w-full h-full object-cover", alt: "Visual Preview" }) : /* @__PURE__ */ jsxs("div", { className: "w-full h-full flex flex-col items-center justify-center text-slate-200 dark:text-slate-700", children: [
            /* @__PURE__ */ jsx(FileText, { size: 48 }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold mt-2 uppercase tracking-widest opacity-50", children: "Tanpa Gambar" })
          ] }) })
        ] })
      ] })
    ] })
