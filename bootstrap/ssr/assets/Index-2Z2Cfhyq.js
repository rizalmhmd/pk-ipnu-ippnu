...
function NationalCalendar({ agendas = [], nationalHolidays = [] }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative z-0 isolate", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 p-8 border-b border-slate-100 flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsx("button", { onClick: prevMonth, className: "w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-100 transition-all", children: /* @__PURE__ */ jsx("i", { className: "fas fa-chevron-left" }) }),
              /* @__PURE__ */ jsx("button", { onClick: nextMonth, className: "w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-100 transition-all", children: /* @__PURE__ */ jsx("i", { className: "fas fa-chevron-right" }) })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-4 md:p-8", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-7 gap-px bg-slate-100 rounded-2xl overflow-hidden border border-slate-100", children: [
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { children: selectedEvent && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "w-[95%] max-w-md bg-white rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] p-8 md:p-10 border border-white relative pointer-events-auto", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setSelectedEvent(null),
...
function AgendaIndex({ agendas = [], todayAgendas = [], pageSetting, nationalHolidays = [] }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6 md:px-12 py-12", children: [
      /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-16", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-100 p-2 rounded-2xl flex gap-2", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-12 xl:gap-20", children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5 mb-10", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-14 h-14 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl flex items-center justify-center text-emerald-400 shadow-inner", children: /* @__PURE__ */ jsx("i", { className: "fas fa-calendar-check text-2xl" }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                    ...
                    todayAgendas.length === 0 && /* @__PURE__ */ jsx("div", { className: "py-4 px-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm", children: /* @__PURE__ */ jsx("p", { className: "text-emerald-100/40 text-sm italic font-medium", children: "✨ Menunggu agenda selanjutnya..." }) })
                  ] })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[3rem] p-8 md:p-10 shadow-2xl shadow-slate-200/40 border border-slate-100 relative overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: categories.map((cat) => /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `w-full flex items-center justify-between px-5 py-4 rounded-[1.25rem] transition-all duration-300 font-bold text-sm group/btn ${activeFilter === cat.id ? "bg-emerald-600 text-white shadow-xl shadow-emerald-900/30 -translate-y-1" : "bg-slate-50 text-slate-500 hover:bg-white hover:shadow-lg hover:shadow-slate-200/50 hover:-translate-y-0.5 border border-transparent hover:border-slate-100"}`,
                children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex-grow", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: viewMode === "list" ? /* @__PURE__ */ jsx(
          motion.div,
          {
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-6", children: items.map((item, idx) => {
                ...
                return /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 md:flex-col md:w-24 md:h-24 md:bg-slate-50 md:rounded-3xl md:justify-center md:border md:border-slate-100 group-hover:bg-emerald-50 group-hover:border-emerald-100 transition-colors shrink-0", children: [
                        /* @__PURE__ */ jsxs("div", { className: `${isHoliday ? item.cat === "nasional" ? "bg-red-600" : "bg-blue-600" : "bg-emerald-600"} text-white w-14 h-14 rounded-2xl flex flex-col items-center justify-center md:bg-transparent ${isHoliday ? item.cat === "nasional" ? "md:text-red-600" : "md:text-blue-600" : "md:text-emerald-600"}`, children: [
            ...
            ] }, month)) : /* @__PURE__ */ jsxs("div", { className: "py-20 text-center bg-white rounded-[3rem] shadow-xl shadow-slate-200/50 border border-slate-100", children: [
