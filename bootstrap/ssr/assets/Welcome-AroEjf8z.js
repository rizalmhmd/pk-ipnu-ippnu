...
function Home({ posts, articles, pageSetting, greeting, agendas, statistics }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    statistics && statistics.length > 0 && /* @__PURE__ */ jsx("section", { className: "bg-white py-20 border-b border-slate-50", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-6 sm:px-10 md:px-24", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-12", children: statistics.map((stat, index) => /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsx(StatCard, { statistic: stat, delay: index }) }, stat.id)) }) }) }),
    /* @__PURE__ */ jsx(
      ElegantHero,
      {
