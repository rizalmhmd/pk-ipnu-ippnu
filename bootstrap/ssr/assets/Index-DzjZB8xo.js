        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between pt-8 border-t border-slate-50 dark:border-slate-800", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-xl flex items-center justify-center overflow-hidden border border-slate-50 dark:border-slate-700", children: quote.image ? /* @__PURE__ */ jsx("img", { src: `/storage/${quote.image}`, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx(User, { size: 18, className: "text-slate-300" }) }),
