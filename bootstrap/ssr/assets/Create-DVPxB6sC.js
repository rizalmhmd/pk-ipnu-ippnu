...
import { ArrowLeft, Instagram, UserPlus, User, CloudUpload } from "lucide-react";
function Create() {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Tambah Anggota" }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-extrabold text-slate-900 dark:text-white mb-2", children: "Tambah Anggota Baru" }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 font-medium", children: "Lengkapi data personalia kepengurusan PKPT IPNU IPPNU." })
      ] }),
      /* @__PURE__ */ jsxs(
        Link,
        {
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "grid grid-cols-1 lg:grid-cols-12 gap-10", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-8", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-10 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-900 dark:text-white mb-3", children: "Tingkatan (Level Hierarchy)" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
                value: data.level,
                ...
                children: [
                  /* @__PURE__ */ jsx("option", { value: "1", children: "Level 1: Ketua PKPT" }),
                  /* @__PURE__ */ jsx("option", { value: "2", children: "Level 2: Ketua Departemen / Inti" }),
                  /* @__PURE__ */ jsx("option", { value: "3", children: "Level 3: Anggota Departemen / Staff" })
                ]
              }
            ),
            /* @__PURE__ */ jsx("p", { className: "mt-2 text-[10px] text-slate-400 italic", children: "Level menentukan posisi dalam pohon organisasi." })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-900 dark:text-white mb-3", children: "Departemen / Bidang" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-2 text-[10px] text-slate-400 italic", children: "Gunakan nama yang sama untuk mengelompokkan anggota." })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `flex items-center justify-center gap-3 p-5 rounded-lg border-2 transition-all font-bold ${data.type === "ipnu" ? "bg-emerald-50 dark:bg-emerald-900/20 border-emerald-500 text-emerald-600 dark:text-emerald-400" : "bg-slate-50 dark:bg-slate-800 border-transparent text-slate-400"}`,
                  children: [
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `flex items-center justify-center gap-3 p-5 rounded-lg border-2 transition-all font-bold ${data.type === "ippnu" ? "bg-blue-50 dark:bg-blue-900/20 border-blue-500 text-blue-600 dark:text-blue-400" : "bg-slate-50 dark:bg-slate-800 border-transparent text-slate-400"}`,
                  children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-end gap-3 pt-10 mt-10 border-t border-slate-50 dark:border-slate-800", children: /* @__PURE__ */ jsxs(
          "button",
          {
            type: "submit",
            disabled: processing,
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-4 space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-8 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: `relative group aspect-[3/4] border-2 border-dashed rounded-lg overflow-hidden flex items-center justify-center transition-all ${photoPreview ? "border-emerald-500" : "border-slate-100 dark:border-slate-800 hover:border-emerald-400"}`, children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "file",
            ...
            photoPreview ? /* @__PURE__ */ jsxs("div", { className: "w-full h-full relative", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-lg flex items-center justify-center text-slate-200 dark:text-slate-700 mx-auto mb-4 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsx(User, { size: 32 }) }),
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-6 text-[10px] text-slate-400 font-medium text-center leading-relaxed", children: "Format: JPG atau PNG. Ukuran yang disarankan: 600x800px dengan background polos." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-slate-950 p-8 rounded-lg text-white shadow-2xl shadow-emerald-900/40 relative overflow-hidden h-[300px]", children: [
