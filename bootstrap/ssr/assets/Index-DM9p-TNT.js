    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "relative h-56 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-4 left-4", children: /* @__PURE__ */ jsx("span", { className: "px-4 py-1.5 bg-white/90 backdrop-blur-md text-emerald-600 text-[10px] font-bold uppercase tracking-wider rounded-full shadow-lg", children: "Berita" }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-4", children: [
...
function NewsIndex({ posts, pageSetting }) {
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6 md:px-12 py-20", children: [
      /* @__PURE__ */ jsx(SectionTitle, { centered: true, children: "Warta Organisasi" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10", children: posts.data.map((post, idx) => /* @__PURE__ */ jsx(PostCard, { post, idx }, post.id)) }),
