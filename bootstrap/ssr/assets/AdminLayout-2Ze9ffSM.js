...
import { LayoutDashboard, Newspaper, FileText, Quote, Image, Users, Calendar, UserCheck, BarChart, UserCog, Settings, User, Globe, LogOut, Menu, Sun, Moon, Bell, ChevronDown } from "lucide-react";
...
function AdminLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-0 pointer-events-none dark:hidden overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute -top-40 -left-40 w-96 h-96 bg-emerald-400/20 rounded-full blur-[100px]" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -bottom-40 -right-40 w-96 h-96 bg-blue-400/20 rounded-full blur-[100px]" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-20 left-1/2 -translate-x-1/2 w-[30rem] h-[20rem] bg-emerald-200/30 rounded-full blur-[120px]" })
    ] }),
