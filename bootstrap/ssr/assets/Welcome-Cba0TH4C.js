      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col h-full", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-6", children: [
            ...
            icon && /* @__PURE__ */ jsx("div", { className: `w-8 h-8 md:w-10 md:h-10 ${theme.bg} rounded-full flex items-center justify-center ${theme.text} mb-2 md:mb-4`, children: /* @__PURE__ */ jsx("i", { className: `fas ${icon} text-xs md:text-base` }) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mb-1 md:mb-2", children: /* @__PURE__ */ jsx("span", { className: "text-xl md:text-5xl font-bold text-slate-800 tracking-tight block truncate", children: value }) }),
          (subtitle || unit) && /* @__PURE__ */ jsxs("div", { className: "text-[10px] md:text-xl font-medium text-slate-600 mb-3 md:mb-6 line-clamp-1", children: [
            subtitle,
            " ",
            unit && /* @__PURE__ */ jsx("span", { className: "text-[8px] md:text-sm text-slate-400 ml-1", children: unit })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-auto pt-3 md:pt-6 border-t border-slate-50 hidden md:block", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500 leading-relaxed", children: description }) })
        ] })
      ]
    }
  );
...
function Home({ posts, articles, pageSetting, greeting, agendas, statistics }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    ...
    statistics && statistics.length > 0 && /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 md:px-12 -mt-20 relative z-40 mb-12", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-6", children: statistics.map((stat, index) => /* @__PURE__ */ jsx("div", { className: "h-full", children: /* @__PURE__ */ jsx(StatCard, { statistic: stat, delay: index }) }, stat.id)) }) }),
    /* @__PURE__ */ jsx(
      PageHeaderCard,
      {
