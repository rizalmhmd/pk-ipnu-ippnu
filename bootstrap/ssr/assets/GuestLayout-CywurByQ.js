...
function GuestLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-slate-50 selection:bg-emerald-200 selection:text-emerald-900 px-4", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mb-6 sm:mb-10", children: /* @__PURE__ */ jsxs(Link, { href: "/", className: "flex flex-col items-center gap-3 sm:gap-4 group", children: [
      /* @__PURE__ */ jsx("div", { className: "w-16 h-16 sm:w-20 sm:h-20 bg-emerald-600 rounded-[1.5rem] sm:rounded-[2rem] flex items-center justify-center shadow-2xl shadow-emerald-900/20 group-hover:scale-110 transition-transform duration-500 overflow-hidden", children: siteSetting?.site_logo ? /* @__PURE__ */ jsx("img", { src: `/storage/${siteSetting.site_logo}?v=${siteSetting.updated_at ? new Date(siteSetting.updated_at).getTime() : Date.now()}`, alt: "Logo", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("i", { className: "fas fa-users text-white text-3xl sm:text-4xl" }) }),
