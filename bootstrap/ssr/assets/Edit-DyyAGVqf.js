...
import { ArrowLeft, History, CloudUpload, X, Save, Lightbulb, Image } from "lucide-react";
function Edit({ post }) {
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "grid grid-cols-1 lg:grid-cols-12 gap-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-4 space-y-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 p-8 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "aspect-[4/3] bg-slate-50 dark:bg-slate-800 rounded-lg overflow-hidden border border-slate-100 dark:border-slate-700", children: imagePreview ? /* @__PURE__ */ jsx("img", { src: imagePreview, className: "w-full h-full object-cover", alt: "Visual Preview" }) : /* @__PURE__ */ jsx("div", { className: "w-full h-full flex flex-col items-center justify-center text-slate-200 dark:text-slate-700 scale-150", children: /* @__PURE__ */ jsx(Image, { size: 48 }) }) })
        ] })
      ] })
    ] })
  ] });
