...
function Index({ quotes }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-8", children: quotes.map((quote, idx) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mb-8 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg w-fit text-emerald-600 dark:text-emerald-400", children: /* @__PURE__ */ jsx(Quote, { size: 24 }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between pt-8 border-t border-slate-50 dark:border-slate-800", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center overflow-hidden border border-slate-50 dark:border-slate-700", children: quote.image ? /* @__PURE__ */ jsx("img", { src: quote.image_url, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx(User, { size: 18, className: "text-slate-300" }) }),
    ...
    quotes.length === 0 && /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800 p-20 text-center shadow-xl shadow-slate-200/50 dark:shadow-none mt-10", children: [
      /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-slate-50 dark:bg-slate-800 rounded-lg flex items-center justify-center text-slate-200 dark:text-slate-700 mx-auto mb-6", children: /* @__PURE__ */ jsx(Quote, { size: 40 }) }),
