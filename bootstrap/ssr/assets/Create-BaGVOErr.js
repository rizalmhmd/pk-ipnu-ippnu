...
function Create() {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Tambah Statistik" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-slate-800 dark:text-white", children: "Tambah Statistik" }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-sm", children: "Buat data statistik baru untuk beranda." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 p-6 sm:p-8 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "col-span-2", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-3", children: icons.map((icon) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `w-12 h-12 rounded-lg flex items-center justify-center transition-all ${data.icon === icon ? "bg-emerald-600 text-white shadow-lg shadow-emerald-600/30 scale-110" : "bg-slate-50 dark:bg-slate-800 text-slate-400 hover:bg-slate-100 hover:text-slate-600"}`,
          ...
          /* @__PURE__ */ jsxs("div", { className: "col-span-2", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-5 gap-3", children: colors.map((color) => /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `flex items-center gap-3 p-2 rounded-lg border transition-all ${data.color === color.id ? "border-emerald-500 bg-emerald-50 dark:bg-emerald-900/10 ring-1 ring-emerald-500" : "border-slate-200 dark:border-slate-700 hover:border-slate-300"}`,
                children: [
