...
import { Newspaper, FileText, Users, Calendar, UserCheck, Image, Quote, Activity, ChevronRight } from "lucide-react";
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-emerald-600 p-6 md:p-10 rounded-lg text-white shadow-2xl shadow-emerald-900/20 relative overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-3 md:gap-4", children: shortcuts.map((shortcut, idx) => /* @__PURE__ */ jsxs(
                  Link,
                  {
                    href: shortcut.href,
