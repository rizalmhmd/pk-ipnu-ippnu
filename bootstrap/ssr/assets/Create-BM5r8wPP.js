...
function Create() {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Tambah Artikel" }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-extrabold text-slate-900 dark:text-white mb-2", children: "Tambah Artikel Baru" }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 font-medium", children: "Buat konten artikel mendalam dan informatif untuk organisasi Anda." })
      ] }),
      /* @__PURE__ */ jsxs(
        Link,
        {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: `relative group border-2 border-dashed rounded-lg p-10 text-center transition-all ${imagePreview ? "border-emerald-500 bg-emerald-50/30 dark:bg-emerald-900/10" : "border-slate-100 dark:border-slate-800 hover:border-emerald-400 dark:hover:border-emerald-600"}`, children: [
            ...
            imagePreview ? /* @__PURE__ */ jsxs("div", { className: "relative inline-block", children: [
              ...
              /* @__PURE__ */ jsx("h5", { className: "font-bold text-slate-900 dark:text-white mb-2 text-lg", children: "Unggah Foto Artikel" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-4 space-y-8", children: /* @__PURE__ */ jsxs("div", { className: "bg-emerald-600 p-10 rounded-lg text-white shadow-2xl shadow-emerald-900/20 relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsx("h5", { className: "text-xl font-bold", children: "Tips Artikel" })
          ] }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("li", { className: "flex gap-4", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium leading-relaxed text-emerald-50", children: "Gunakan bahasa yang lugas dan informatif untuk audiens pembaca." })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 bg-emerald-300 rounded-full shrink-0 mt-1.5" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium leading-relaxed text-emerald-50", children: "Sertakan gambar jika Artikel membutuhkan ilustrasi pendukung." })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 bg-emerald-300 rounded-full shrink-0 mt-1.5" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium leading-relaxed text-emerald-50", children: "Judul menarik akan meningkatkan kemungkinan artikel dibaca." })
            ] })
          ] })
        ] })
      ] }) })
