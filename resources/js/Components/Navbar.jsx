            ...
            <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
                <Link href="/" className="flex items-center gap-2 sm:gap-3 group">
                    ...
                    <div className="flex flex-col">
                        <span className="text-base sm:text-xl font-bold text-white font-serif tracking-tight leading-none" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5), 0 1px 3px rgba(0,0,0,0.4)' }}>
                            {siteSetting?.site_name || 'PKPT IPNU IPPNU'}
                        </span>
                        <span className="text-[9px] sm:text-[10px] text-emerald-200 font-bold uppercase tracking-widest mt-0.5 sm:mt-1" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.5)' }}>Portal Resmi</span>
                    </div>
                </Link>
