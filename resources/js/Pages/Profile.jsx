                            ...
                            <div className="flex flex-wrap gap-3 sm:gap-4">
                                {['visi-misi', 'sejarah'].map((tab) => (
                                    <button
                                        ...
                                        className={`px-6 py-3 sm:px-8 sm:py-4 rounded-xl sm:rounded-2xl text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 ${selectedTab === tab
                                    ...
                                    <div className="space-y-8 sm:space-y-10">
                                        <div className="group">
                                            <h4 className="text-xl sm:text-2xl font-bold text-slate-800 font-serif mb-4 flex items-center gap-4 group-hover:text-emerald-700 transition-colors">
                                                <span className="w-8 h-8 sm:w-10 sm:h-10 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center text-[10px] sm:text-xs font-bold">01</span>
                                                Visi Kami
                                            </h4>
                                        ...
                                        <div>
                                            <h4 className="text-xl sm:text-2xl font-bold text-slate-800 font-serif mb-6 flex items-center gap-4">
                                                <span className="w-8 h-8 sm:w-10 sm:h-10 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center text-[10px] sm:text-xs font-bold">02</span>
                                                Misi Kami
                                            </h4>
