    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-10">
                ...
                <p className="text-slate-500 dark:text-slate-400 font-medium">Informasi personal dan keamanan akun administrator.</p>
            </div>
                ...
                <div className="lg:col-span-12 xl:col-span-7">
                    <form onSubmit={updateProfile} className="bg-white dark:bg-slate-900 p-10 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none">
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-slate-900 dark:text-white leading-none">Informasi Profil</h3>
                                <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">Update data publik akun Anda</p>
                            </div>
                        </div>
