        ...
        <AdminLayout>
            ...
            <div className="max-w-3xl mx-auto">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Tambah Statistik</h1>
                        <p className="text-slate-500 dark:text-slate-400 text-sm">Buat data statistik baru untuk beranda.</p>
                    </div>
                </div>
