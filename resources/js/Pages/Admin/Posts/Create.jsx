    ...
    return (
        <AdminLayout>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div>
                    <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-2">Tambah Berita Baru</h1>
                    <p className="text-slate-500 dark:text-slate-400 font-medium">Publikasikan informasi dan update terbaru untuk audiens Anda.</p>
                </div>
                <Link
                                ...
                                <div className={`relative group border-2 border-dashed rounded-[2.5rem] p-10 text-center transition-all ${imagePreview ? 'border-emerald-500 bg-emerald-50/30 dark:bg-emerald-900/10' : 'border-slate-100 dark:border-slate-800 hover:border-emerald-400 dark:hover:border-emerald-600'
                                    ...
                                    {imagePreview ? (
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <h5 className="font-bold text-slate-900 dark:text-white mb-2 text-lg">Unggah Foto Berita</h5>
                    ...
                    <div className="bg-emerald-600 p-10 rounded-[3rem] text-white shadow-2xl shadow-emerald-900/20 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h5 className="text-xl font-bold">Tips Menulis</h5>
                            </div>
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    <div className="w-1.5 h-1.5 bg-emerald-300 rounded-full shrink-0 mt-1.5"></div>
                                    <p className="text-sm font-medium leading-relaxed text-emerald-50">Gunakan judul yang singkat dan menggambarkan isi berita secara tepat.</p>
                                </li>
                                <li className="flex gap-4">
                                    <div className="w-1.5 h-1.5 bg-emerald-300 rounded-full shrink-0 mt-1.5"></div>
                                    <p className="text-sm font-medium leading-relaxed text-emerald-50">Pastikan gambar utama berkualitas tinggi untuk daya tarik visual.</p>
                                </li>
                                <li className="flex gap-4">
                                    <div className="w-1.5 h-1.5 bg-emerald-300 rounded-full shrink-0 mt-1.5"></div>
                                    <p className="text-sm font-medium leading-relaxed text-emerald-50">Gunakan paragraf yang tidak terlalu panjang untuk kenyamanan pembaca.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
