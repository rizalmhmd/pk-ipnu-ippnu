    ...
    return (
        <AdminLayout>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div>
                    <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-2">Kelola Berita</h1>
                    <p className="text-slate-500 dark:text-slate-400 font-medium">Manajemen seluruh konten berita dan informasi organisasi.</p>
                </div>
                <Link
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden">
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/50 dark:bg-slate-800/50">
                                <th className="px-8 py-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Informasi Berita</th>
                ...
                {posts.data.length === 0 && (
                    <div className="py-20 text-center">
                        ...
                        <h5 className="text-lg font-bold text-slate-400">Belum Ada Berita</h5>
                        <p className="text-slate-300 dark:text-slate-600 text-sm italic">Mulai dengan menambahkan berita pertama Anda.</p>
                    </div>
                )}
            </div>
