                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control-premium @error('instagram') is-invalid @enderror" id="instagram" name="instagram" value="{{ old('instagram') }}" placeholder="rizalmhmd_">
                        </div>
                        @error('instagram')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="row gx-4">
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <select class="form-select form-control-premium w-100 @error('type') is-invalid @enderror" id="type" name="type" required>
                            <option value="ipnu" {{ old('type') == 'ipnu' ? 'selected' : '' }}>IPNU</option>
                            <option value="ippnu" {{ old('type') == 'ippnu' ? 'selected' : '' }}>IPPNU</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control-premium w-100 @error('order') is-invalid @enderror" id="order" name="order" value="{{ old('order', 0) }}" placeholder="0">
