...
function Login({ status, canResetPassword }) {
  ...
  return /* @__PURE__ */ jsxs(GuestLayout, { children: [
    ...
    status && /* @__PURE__ */ jsx("div", { className: "mb-6 font-bold text-sm text-emerald-600 bg-emerald-50 p-4 rounded-lg border border-emerald-100 italic", children: status }),
