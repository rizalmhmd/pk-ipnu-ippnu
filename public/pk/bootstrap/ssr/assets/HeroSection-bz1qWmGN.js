...
function HeroSection({ bgImage, hideIndicators = false }) {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative h-screen w-full overflow-hidden flex flex-col items-center justify-center shadow-2xl group bg-neutral-950", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-6 sm:px-10 relative z-20 flex flex-col items-center justify-center text-center flex-1 w-full", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: quotesToDisplay ? /* @__PURE__ */ jsxs(
      motion.div,
      {
    ...
    quotesToDisplay?.length > 1 && !hideIndicators && /* @__PURE__ */ jsx("div", { className: "absolute bottom-6 md:bottom-10 left-0 right-0 z-30 px-6 md:px-12 flex justify-center", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-6xl", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-8", children: quotesToDisplay.map((quote, idx) => /* @__PURE__ */ jsxs(
      "button",
      {
